...
const fetchContestTeams = (contestId) =>
  axiosInstance.get(`/duo-contests/${contestId}/teams`).then(res => res.data)

const fetchContestDetails = (contestId) =>
  axiosInstance.get(`/duo-contests/${contestId}`).then(res => res.data)

const fetchContestResults = (contestId) =>
  axiosInstance.get(`/duo-contests/${contestId}/results`).then(res => res.data)

const declareResults = (contestId, resultsData) =>
  axiosInstance.post(`/duo-contests/${contestId}/declare`, resultsData).then(res => res.data)
