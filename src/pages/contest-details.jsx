...
// Utility function to convert rupee symbols to diamond symbols
function convertToDeiamond(text) {
  if (!text) return text;
  ...
  useEffect(() => {
    const fetchContest = async () => {
      try {
        ...
        // Convert rupee symbols to diamond symbols in contest data
        if (contestData.prize_description) {
          contestData.prize_description = convertToDeiamond(contestData.prize_description);
        }
        ...
        if (prizeRes.ok) {
          ...
          // Convert rupee symbols to diamond symbols in prize distribution
          const updatedPrizeData = prizeData.map(prize => ({
            ...prize,
            prize_amount: convertToDeiamond(prize.prize_amount),
            description: convertToDeiamond(prize.description),
          }));
          setPrizeDistribution(updatedPrizeData);
        }
