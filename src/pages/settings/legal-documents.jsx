...
const LegalDocuments = () => {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        const res = await axios.get("https://macstormbattle-backend-2.onrender.com/api/legal-docs")
  ...
  const handlePublishLive = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://macstormbattle-backend-2.onrender.com/api/legal-docs/${selectedDocument.id}`,
        updateData
      )
  ...
  const handleAddDocumentSubmit = async () => {
    try {
      const res = await axios.post("https://macstormbattle-backend-2.onrender.com/api/legal-docs", newDocData)
      const newDoc = {
        ...res.data,
  ...
  const handleDeleteDocument = async () => {
    ...
    try {
      await axios.delete(`https://macstormbattle-backend-2.onrender.com/api/legal-docs/${documentToDelete.id}`)
