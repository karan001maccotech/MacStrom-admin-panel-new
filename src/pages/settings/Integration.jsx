...
const Integration = () => {
  ...
  useEffect(() => {
    const fetchIntegrationSettings = async () => {
      try {
        const res = await axios.get("https://macstormbattle-backend-2.onrender.com/api/integrations")
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      const res = await axios.post("https://macstormbattle-backend-2.onrender.com/api/integrations", payload, {
        headers: {
