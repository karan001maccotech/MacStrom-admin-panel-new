...
const SecuritySettings = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const response = await axios.get("https://macstormbattle-backend-2.onrender.com/api/security-settings")
  ...
  const handleAddIpRange = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://macstormbattle-backend-2.onrender.com/api/security-settings", settingsToSave)
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      await axios.post("https://macstormbattle-backend-2.onrender.com/api/security-settings", settingsToSave)
