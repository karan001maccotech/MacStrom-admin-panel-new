...
const HowToPlay = () => {
  ...
  const fetchSteps = async () => {
    try {
      const res = await axios.get("https://macstormbattle-backend-2.onrender.com/api/how-to-play")
      setSteps(res.data)
    } catch (err) {
  ...
  const handleAddStepSubmit = async () => {
    try {
      ...
      await axios.post("https://macstormbattle-backend-2.onrender.com/api/how-to-play", payload)
      await fetchSteps()
      handleCloseAddModal()
    } catch (error) {
  ...
  const handleEditStepSubmit = async () => {
    ...
    try {
      ...
      await axios.put(`https://macstormbattle-backend-2.onrender.com/api/how-to-play/${editStep.id}`, payload)
      await fetchSteps()
  ...
  const handleDeleteStep = async (id) => {
    if (!id) return
    try {
      await axios.delete(`https://macstormbattle-backend-2.onrender.com/api/how-to-play/${id}`)
