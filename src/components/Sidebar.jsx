...
const menuItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: "Games Registration", path: "/games-registration" },
      { label: "Group Management", path: "/group-management" },
      { label: "Registration Form Controls", path: "/registration-details" },
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: "Email Controls", path: "/email-notifications" }
    ],
  },
  {
    label: "Reports",
